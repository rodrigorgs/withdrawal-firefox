all: data/firefox-backouts.rds data/firefox-bugs.rds data/firefox-commits.rds data/firefox-events.rds data/firefox-fixes.rds data/firefox-reviews.rds data/mozilla-hg-log.bz2 report/detect-backout-commits.html report/detect-fix-commits.html report/detect-review-minus.html report/load-firefox-bugs.html report/load-firefox-commits.html report/load-firefox-events.html

clean:
	rm -f data/firefox-backouts.rds data/firefox-bugs.rds data/firefox-commits.rds data/firefox-events.rds data/firefox-fixes.rds data/firefox-reviews.rds data/mozilla-hg-log.bz2 report/detect-backout-commits.html report/detect-fix-commits.html report/detect-review-minus.html report/load-firefox-bugs.html report/load-firefox-commits.html report/load-firefox-events.html
